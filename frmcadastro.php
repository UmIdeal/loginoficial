		...
		<script type="text/javascript">
			$(document).ready(function(){
			    ...
			    $('#meu_form').validate({
					...
					messages:{
						login:{ 
                                                     required: 'Este Campo &eacute; obrigat&oaucte;rio' , 
                                                     remote: '<font color="red">Este Login j&aacute; est&aacute; em uso.</font>'},//,
                                                conflogin:{
                                                       required: 'Este campo de confirmação de email é obrigat&oaucte;rio',
...
<form id="meu_form" action="inserirNovoUsuario.php" method="post" >
		...
		<br />
                ...
                <inpt type="text" name="conflogin" id="conflogin" />
		<br />ut type="text" name="conflogin" id="conflogin" />
		<br />
		Senha:<br />
